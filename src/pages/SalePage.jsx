...
export default function SalePage() {
  ...
  const addRow = () => {
    ...
    if (parseFloat(curRow.pcs) <= 0) {
      showMsg("Quantity must be > 0", "error");
      return;
    }
    if (selItemIdx !== null) {
      setItems((prev) => {
  ...
  const payBtnClass = (mode) =>
    `sl-pay-btn${paymentMode === mode ? " active-" + mode.toLowerCase() : ""}`;
    ...
    <div className="sl-page">
      ...
      <div className="xp-titlebar">
        ...
        <span className="xp-tb-title">
          Sale — Asim Electric &amp; Electronic Store
        </span>
        ...
        <div className="sl-right">
          ...
          <div className="sl-totals-panel">
            ...
            <div className="sl-total-row">
              <label>Balance</label>
              <input
                className={`sl-total-val highlight${balance > 0 ? " danger" : balance < 0 ? " success" : ""}`}

...
const HOLD_KEY = "asim_hold_bills_purchase_v1";
...
export default function PurchasePage() {
  ...
  const openSaleConfirm = () => {
    ...
    if (
      customerId &&
      (customerType === "credit" || customerType === "supplier")
    ) {
      ...
      <div className={`sl-page${creditWarning ? " sl-credit-mode" : ""}`}>
        ...
        <div className="xp-titlebar">
          ...
          <span className="xp-tb-title">
            Purchase Invoice — Asim Electric &amp; Electronic Store
          </span>
          <div className="xp-tb-actions">
            {editId && <div className="sl-edit-badge">✏ Editing Purchase</div>}

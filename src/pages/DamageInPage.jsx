    ...
    >
      <div className="xp-modal xp-modal-lg">
        ...
        >
          ...
          >
            {rows.length} result(s) - Up/Down navigate | Enter = select | Esc =
            close
          </span>
        </div>
...
function PrintModal({ record, onClose }) {
  ...
  const doPrint = () => {
    ...
    win.document.write(
      "<!DOCTYPE html><html><head><title>Damage In " +
        invoiceNo +
        "</title><style>body{font-family:Arial,sans-serif;font-size:12px;padding:20px}h2,h3{margin:0 0 4px;text-align:center}table{width:100%;border-collapse:collapse;margin-top:10px}th,td{border:1px solid #ccc;padding:5px}th{background:#e8e8e8}.meta{display:flex;gap:16px;flex-wrap:wrap;margin:8px 0;padding:6px 10px;background:#f5f5f5;border:1px solid #ddd}.tots{float:right;min-width:240px;margin-top:10px}.tr{display:flex;justify-content:space-between;padding:2px 0}.tr.b{font-weight:bold;border-top:1px solid #000;margin-top:4px}</style></head><body>",
    );
    win.document.write("<h2>" + SHOP_NAME + "</h2><h3>DAMAGE IN</h3>");
    win.document.write(
    ...
    win.document.write(
      "<div class='tots'><div class='tr'><span>Total Qty</span><span>" +
        ...
        "</span></div><div class='tr b'><span>Net Receivable</span><span>Rs. " +
    ...
    >
      <div className="xp-modal xp-modal-lg">
        ...
        <div className="xp-modal-footer">
          <button className="xp-btn xp-btn-primary xp-btn-sm" onClick={doPrint}>
            Print / PDF
          </button>
...
export default function DamageInPage() {
  ...
  // FIX 1: Hold Bills — working local hold/restore
  ...
  // FIX 1: Hold current bill into panel
  ...
  // Reset without clearing holdBills
  ...
  const handleProductSelect = (product) => {
    ...
    setRows((prev) => {
      ...
      next[activeRow] = {
        ...
        uom: product._meas || "",
        // FIX 3: packing as text from product, user can overwrite
  ...
  return (
    <div className="qt-page dmg-page">
      {showSearch && (
        <SearchModal
      ...
      {/* Titlebar */}
      <div className="xp-titlebar dmg-titlebar-in">
        <svg
          width="15"
          height="15"
          viewBox="0 0 16 16"
      ...
      <div className="qt-body">
        ...
        <div className="dmg-header-band">
          <div className="dmg-label-badge dmg-in-badge">Damage In</div>
          ...
          <div style={{ flex: 1 }}>
            ...
            >
              <input
                ...
                tabIndex={1}
              />
              {/* FIX 3: Packing = free text input, NOT dropdown */}
                    ...
                    {rows.map((row, i) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          {/* FIX 3: Packing as text in table too */}
                          <td>
                            <input
                              className="qt-cell"
                              style={{ width: "100%" }}
        ...
        <div className="dmg-action-bar">
          ...
          <button
            className="xp-btn xp-btn-primary xp-btn-sm dmg-act-btn"
            onClick={handleSave}
            disabled={saving}
          >
          ...
          >
            <label style={{ fontSize: "var(--xp-fs-xs)" }}>
              <input type="radio" name="printModeIn" defaultChecked /> Thermal
            </label>
            <label style={{ fontSize: "var(--xp-fs-xs)" }}>
              <input type="radio" name="printModeIn" /> Laser
            </label>
          </div>
          <button
        ...
        <div className="qt-saved-section">
          <div className="qt-saved-header">
            <span className="qt-saved-title">Saved Damage In Records</span>
